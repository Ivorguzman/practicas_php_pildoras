...
superglobal $_GET. Si está configurado, verifica si el valor es igual a 1. Si es así, redirige al
usuario a la página "Location:81_82_index.php". Si el valor no es igual a 1, asigna el valor del parámetro
"pagina" a la variable . */
...
$numeroFila = $resultSetRegistro->rowCount();
