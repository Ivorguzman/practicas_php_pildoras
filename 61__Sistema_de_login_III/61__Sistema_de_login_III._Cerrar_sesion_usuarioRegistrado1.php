...
// capa de comprobacion de secion
...
<body>
   ...
   <p>
   <h2>Esto solo para usuarios registrados 1</h2>
   </p>

   <a href="61__Sistema_de_login_III._Cerrar_sesion_usuarioRegistrado2.php">Ir a pagina usuarios registrados 2 </a>
   <a href="61__Sistema_de_login_III._Cerrar_sesion_usuarioRegistrado3.php">Ir a pagina usuarios registrados
      3</a><br /><br />
