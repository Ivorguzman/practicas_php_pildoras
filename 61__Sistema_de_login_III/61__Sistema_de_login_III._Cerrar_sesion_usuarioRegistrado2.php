...
<body>
   ...
   <p><h2>Esto solo para usuarios registrados 2</h2></p><br />
   <a href="61__Sistema_de_login_III._Cerrar_sesion_matarSecion.php">Cerrar sesión</a>
   

   <a href="61__Sistema_de_login_III._Cerrar_sesion_usuarioRegistrado1.php">Ir a pagina usuarios registrados 1 </a>
   <a href="61__Sistema_de_login_III._Cerrar_sesion_usuarioRegistrado3.php">Ir a pagina usuarios registrados 3</a><br /><br />
