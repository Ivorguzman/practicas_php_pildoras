...
try {
   ...
   if ($existeRegistro) {
      ...
      header("Location: 60__Sistema_de_login_II_UsuarioRegistrado1.php");

   } else {

      header("Location: 60__Sistema_de_login_II_sesiones_formulario.php"); // redirigir usuario a la pagina espesificada
   }
