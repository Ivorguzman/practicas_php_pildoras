...
<head>
   ...
   <title>super cochinada 67</title>
...
<body>
   ...
   if ($autenticado == true) {
      print_r("57-$-autenticado ==>  " . $autenticado);
   } else {
      echo "59-$-autenticado ==> 0  ";
   };
   ...
   if (isset($_POST["recordar"])) {
      print_r("66-VSG  $ POST[recordar] ==>  " . $_POST["recordar"]) . " (Se creo) ";
   } else {
      echo " 76-$ POST[recordar ==> 0 ( No esxiste)";
   };
   ...
   if (isset($_POST["enviar"])) {
      try {
         ...
         if ($existeRegistro != 0) {
           ...
           `true`. el ` */
            $autenticado = true;
            print_r(" 164-$-autenticado ==>  " . $autenticado);

            echo "<br>";
            if (!isset($_SESSION["usuario"])) {

               print_r("169-$ SESSION[usuario] ==> (no existe) ");
            };
            ...
            a lo largo de su interacción con el sitio web. */
               ...
               print_r("193-$ SESSION[usuario] ==> " . $_SESSION["usuario"]);
               echo "<br>";
               print_r("195-$ SESSION[clave] ==> " . $_SESSION["clave"]);
               echo "<br>";
               echo "197-fuera";

               if (!isset($_SESSION["usuario"])) {
                  echo "200-dentro";
                  print_r("2001-$ SESSION[usuario] ==> " . $_SESSION["usuario"]);
                  print_r("202-$ SESSION[clave] ==> " . $_SESSION["clave"]);
                  sleep(10);
                  include("67__Cookies_V__Práctica_3_formulario.php");
               };
            }
            ...
            if (isset($_POST["recordar"])) {
               ...
               echo "<br>";
               print_r("212-setcookie(nombre_usuario) ==> " . $_POST["campo_clave"]);
               ...
               print "<pre>";
               if (isset($_COOKIE["nombre_usuario"])) {
                  print_r("216-$-autenticado ==>  " . $autenticado);
                  echo "<br>";
                  print_r("218-recordar==>  " . $_POST["recordar"]);
                  echo "<br>";
                  print_r("220-setcookie(nombre_usuario)==>  " . $_COOKIE["nombre_usuario"]);
                  echo "<br>";
                  print "</pre>";
               };
               print "<pre>";
   ...
   <div class="contenedor">
      ...
      <?php
      echo "249-fuera del if" . "<br>";
      if (!$autenticado) {
         echo "251-dentro del 2do if" . "<br>";
         if (!isset($_COOKIE["nombre_usuario"])) {
            echo "253-entro al  include" . "<br>";
            include("67__Cookies_V__Práctica_3_formulario.php");
         }
      }
      ?>
   ...
   <h2>CONTENIDO DE LA WEB <br> 261h2 </h2>
   <table width="800" border="0">
      <tr>
         <td><img src="67__Cookies_V__Práctica_3_1.JPG" width="300" height="166"></td>
         <td><img src="67__Cookies_V__Práctica_3_3.JPG" width=" 300" height="171"></td>
      </tr>
      <tr>
         <td><img src="67__Cookies_V__Práctica_3_2.JPG" width="300" height="166"></td>
         <td><img src="67__Cookies_V__Práctica_3_4.JPG" width="300" height="166"></td>
      </tr>
      <tr class="tr_centrado">
         <td><a href="67__Cookies_V__Práctica_3_Cerrar_sesion_usuarioRegistrado.php"> Cerrar sesion</a></td>
      </tr>
   </table>

   <?php

   /* El código  está comprobando si el usuario está autenticado o si hay una cookie con el nombre
"nombre_usuario" configurado. Si alguna de estas condiciones se cumple, incluye el archivo
"67__Cookies_V__Práctica_3_usuario_registrado.html". */
   if ($autenticado == true || isset($_COOKIE["nombre_usuario"])) {

      include("67__Cookies_V__Práctica_3_usuario_registrado.html");
   }
   ?>
